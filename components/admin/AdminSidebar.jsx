...
import { HomeIcon, TicketPercentIcon, PlusSquareIcon, ListOrderedIcon, ShoppingBasketIcon, FolderIcon } from "lucide-react"
...
const AdminSidebar = () => {
  ...
  const sidebarLinks = [
    ...
    { name: 'Manage Products', href: '/admin/products', icon: ShoppingBasketIcon },
    { name: 'Orders', href: '/admin/orders', icon: ListOrderedIcon },
    { name: 'Categories', href: '/admin/categories', icon: FolderIcon }, // 👈 New Categories
